...
<img width="50%" alt="Bitscape Logo" src="[/Azure/alz-terraform-accelerator/raw/main/docs/wiki/media/MS-Azure_logo_horiz_c-gray_rgb.png](https://sacdnprdeus001.blob.core.windows.net/bitscape-logos/Bitscape-Logo-xl.png)" style="visibility:visible;max-width:100%;">
